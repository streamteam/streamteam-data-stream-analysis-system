...
import ch.unibas.dmi.dbis.streamTeam.tasks.football.KickoffDetectionTask;
...
/**
 * Application which describes the Kickoff Detection Worker by setting its input streams, its output streams, and the StreamTask that specifies its analysis logic.
 */
public class KickoffDetectionApplication extends AbstractApplication {

    /**
     * Initialize the input stream set of the Kickoff Detection Worker.
     *
    ...
    /**
     * Initialize the output stream set of the Kickoff Detection Worker.
     *
    ...
    public Set<String> initOutputStreams() {
        ...
        outputTopics.add(KickoffEventStreamElement.STREAMNAME);
        return outputTopics;
    }

    /**
     * Initialize the StreamTaskFactory of the Kickoff Detection Worker.
     *
    ...
    public StreamTaskFactory initStreamTaskFactory() {
        return new StreamTaskFactory() {
            ...
            public StreamTask createInstance() {
                return new KickoffDetectionTask();
            }
        };
    }
}
