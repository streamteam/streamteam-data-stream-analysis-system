...
import ch.unibas.dmi.dbis.streamTeam.tasks.football.KickDetectionTask;
...
/**
 * Application which describes the Kick Detection Worker.
 */
public class KickDetectionApplication extends AbstractApplication {

    /**
     * Initialize the input stream set of the Kick Detection Worker.
     *
    ...
    public Set<String> initInputStreams() {
        ...
        inputTopics.add(DuelEventStreamElement.STREAMNAME);
        inputTopics.add(UnderPressureEventStreamElement.STREAMNAME);
        inputTopics.add(MatchMetadataStreamElement.STREAMNAME);
        return inputTopics;
    }

    /**
     * Initialize the output stream set of the Kick Detection Worker by setting its input streams, its output streams, and the StreamTask that specifies its analysis logic.
     *
    ...
    public Set<String> initOutputStreams() {
        ...
        outputTopics.add(KickEventStreamElement.STREAMNAME);
        return outputTopics;
    }

    /**
     * Initialize the StreamTaskFactory of the Kick Detection Worker.
     *
