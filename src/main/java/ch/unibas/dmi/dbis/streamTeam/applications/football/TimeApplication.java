...
import ch.unibas.dmi.dbis.streamTeam.tasks.football.TimeTask;
...
/**
 * Application which describes the Time Worker by setting its input streams, its output streams, and the StreamTask that specifies its analysis logic.
 */
public class TimeApplication extends AbstractApplication {

    /**
     * Initialize the input stream set of the Time Worker.
     *
    ...
    /**
     * Initialize the output stream set of the Time Worker.
     *
    ...
    public Set<String> initOutputStreams() {
        ...
        outputTopics.add(MatchTimeProgressEventStreamElement.STREAMNAME);
        return outputTopics;
    }

    /**
     * Initialize the StreamTaskFactory of the Time Worker.
     *
