...
import ch.unibas.dmi.dbis.streamTeam.tasks.football.HeatmapTask;
...
/**
 * Application which describes the Heatmap Worker by setting its input streams, its output streams, and the StreamTask that specifies its analysis logic.
 */
public class HeatmapApplication extends AbstractApplication {

    /**
     * Initialize the input stream set of the Heatmap Worker.
     *
    ...
    /**
     * Initialize the output stream set of the Heatmap Worker.
     *
    ...
    public Set<String> initOutputStreams() {
        ...
        outputTopics.add(HeatmapStatisticsStreamElement.STREAMNAME);
        return outputTopics;
    }

    /**
     * Initialize the StreamTaskFactory of the Heatmap Worker.
     *
